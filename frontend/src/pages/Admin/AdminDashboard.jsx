...
export default function AdminDashboard() {
    ...
    const [userActivities, setUserActivities] = useState([
        ...
        },
        {
            id: 3,
            user: "cooking_pro",
            action: "submitted recipe for review",
        ...
        },
        {
            ...
            user: "chef_jamie",
            action: "rated recipe",
            item: "Chicken Tikka Masala (4.5 stars)",
            time: "4 hours ago"
        }
    ]);
    ...
    const renderAlertIcon = (type) => {
        switch (type) {
            case 'error':
                return (
                    <div
                        className="flex-shrink-0 w-10 h-10 rounded-full bg-red-100 flex items-center justify-center text-red-500">
            ...
            case 'warning':
                return (
                    <div
                        className="flex-shrink-0 w-10 h-10 rounded-full bg-yellow-100 flex items-center justify-center text-yellow-500">
                        <svg xmlns="http://www.w3.org/2000/svg"
                             className="h-6 w-6" fill="none" viewBox="0 0 24 24"
                             stroke="currentColor">
                            <path strokeLinecap="round" strokeLinejoin="round"
            ...
            case 'info':
                return (
                    <div
                        className="flex-shrink-0 w-10 h-10 rounded-full bg-blue-100 flex items-center justify-center text-blue-500">
                        <svg xmlns="http://www.w3.org/2000/svg"
                             className="h-6 w-6" fill="none" viewBox="0 0 24 24"
                             stroke="currentColor">
                            <path strokeLinecap="round" strokeLinejoin="round"
            ...
            case 'success':
                return (
                    <div
                        className="flex-shrink-0 w-10 h-10 rounded-full bg-green-100 flex items-center justify-center text-green-500">
                        <svg xmlns="http://www.w3.org/2000/svg"
                             className="h-6 w-6" fill="none" viewBox="0 0 24 24"
                             stroke="currentColor">
                            <path strokeLinecap="round" strokeLinejoin="round"
            ...
            <div className="grid grid-cols-6 gap-1 h-32 mt-4 items-end">
                {userGrowth.data.map((value, index) => (
                    <div key={index} className="flex flex-col items-center">
                        ...
                        ></div>
                        <span
                            className="text-xs text-gray-600 mt-1">{userGrowth.labels[index]}</span>
                    </div>
                ))}
            </div>
        );
            ...
            <div className="max-w-7xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
                ...
                <div className="bg-white rounded-xl shadow-sm p-6 mb-8">
                    <div
                        ...
                        <div>
                            <h1 className="text-3xl font-bold text-gray-800 mb-2">Admin
                                Dashboard</h1>
                            <p className="text-gray-500">Monitor system
                                performance and user activity</p>
                        </div>
                ...
                {error && (
                    <div
                        className="bg-red-50 border border-red-200 text-red-700 px-6 py-4 rounded-lg mb-8 shadow-sm">
                ...
                {loading ? (
                    <div
                        ...
                        <div
                            className="animate-spin rounded-full h-16 w-16 border-t-4 border-b-4 border-blue-500 mx-auto"></div>
                        <p className="mt-4 text-gray-600">Loading dashboard
                            data...</p>
                    </div>
                ) : (
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                        ...
                        <div className="lg:col-span-2 space-y-8">
                            ...
                            <div
                                ...
                                <div
                                    ...
                                    <div>
                                        ...
                                        <p className="text-xs text-green-600 mt-1">+{systemStats.newUsersThisWeek} this
                                            week</p>
                                    </div>
                                </div>
                                ...
                                <div
                                    className="bg-white rounded-xl shadow-sm p-6 flex items-center">
                                    <div
                                        className="mr-4 bg-green-100 p-3 rounded-full">
                                        <svg xmlns="http://www.w3.org/2000/svg"
                                    ...
                                    <div>
                                        ...
                                        <p className="text-xs text-yellow-600 mt-1">{systemStats.pendingRecipes} pending
                                            review</p>
                                    </div>
                                </div>
                                ...
                                <div
                                    ...
                                    <div>
                                        <p className="text-sm text-gray-500">Active
                                            Today</p>
                                        <h3 className="text-2xl font-bold text-gray-800">{systemStats.activeToday}</h3>
                                        <p className="text-xs text-purple-600 mt-1">{Math.round((systemStats.activeToday / systemStats.totalUsers) * 100)}%
                                            of users</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="bg-white rounded-xl shadow-sm p-6">
                                <div
                                    ...
                                    <h2 className="text-lg font-semibold text-gray-800">User
                                        Growth</h2>
                            ...
                            <div className="bg-white rounded-xl shadow-sm p-6">
                                <div
                                    ...
                                    <h2 className="text-lg font-semibold text-gray-800">Recent
                                        User Activity</h2>
                                    <Link
                                        to="/admin/activity"
                                ...
                                <div className="space-y-4">
                                    {userActivities.map(activity => (
                                        <div key={activity.id}
                                            ...
                                            <div
                                                className="bg-blue-100 text-blue-800 h-10 w-10 rounded-full flex items-center justify-center font-bold text-sm mr-3">
                                            ...
                                            <div className="flex-1">
                                                <div
                                                    ...
                                                    <div>
                                                        <span
                                                            className="font-medium text-gray-900">{activity.user}</span>
                                                        <span
                                                            className="text-gray-600"> {activity.action}</span>
                                                        {activity.item && (
                                                            <span
                                                                className="text-gray-900 font-medium"> {activity.item}</span>
                                                        )}
                                                    </div>
                                                    <span
                                                        className="text-xs text-gray-500">{activity.time}</span>
                                                </div>
                                            </div>
                                        </div>
                                    ))}
                        ...
                        <div className="space-y-8">
                            ...
                            <div className="bg-white rounded-xl shadow-sm p-6">
                                <div
                                    className="flex justify-between items-center mb-6">
                                    <h2 className="text-lg font-semibold text-gray-800">System
                                        Alerts</h2>
                                    <button
                                        ...
                                        <div key={alert.id}
                                            ...
                                            <div className="ml-3 flex-1">
                                                <div
                                                    ...
                                                    <span
                                                        className="text-xs text-gray-500">{alert.time}</span>
                                                </div>
                                            </div>
                                        </div>
                                    ))}
                            ...
                            <div className="bg-white rounded-xl shadow-sm p-6">
                                <div
                                    className="flex justify-between items-center mb-6">
                                    <h2 className="text-lg font-semibold text-gray-800">Popular
                                        Recipes</h2>
                                    <Link
                                        to="/admin/recipes"
                                        className="text-sm text-blue-600 hover:text-blue-800"
                                        ...
                                        <div key={recipe.id}
                                            ...
                                            <div>
                                                ...
                                                <div
                                                    ...
                                                    <div
                                                        className="flex items-center text-yellow-400 mr-2">
                                                        <svg
                                                        ...
                                                        <span
                                                            className="text-xs text-gray-600">{recipe.rating}</span>
                                                    </div>
                                                    <div
                ...
                <div
                    className="mt-8 bg-white rounded-xl shadow-sm p-6 overflow-hidden">
                    <div className="flex justify-between items-center mb-6">
                        <h2 className="text-lg font-semibold text-gray-800">Recent
                            Pending Recipe Submissions</h2>
                        <Link
                        ...
                        <table className="min-w-full divide-y divide-gray-200">
                            ...
                            <tr>
                                <td className="px-6 py-4 whitespace-nowrap">
                                    <div
                                        className="text-sm font-medium text-gray-900">Thai
                                        Green Curry
                                    </div>
                                </td>
                                <td className="px-6 py-4 whitespace-nowrap">
                                    <div
                                        className="text-sm text-gray-900">cooking_pro
                                    </div>
                                </td>
                                <td className="px-6 py-4 whitespace-nowrap">
                                ...
                                <td className="px-6 py-4 whitespace-nowrap text-sm">
                                    <button
                                        className="text-blue-600 hover:text-blue-900 mr-3">Review
                                    </button>
                                    <button
                                        className="text-green-600 hover:text-green-900 mr-3">Approve
                                    </button>
                                    <button
                                        className="text-red-600 hover:text-red-900">Reject
                                    </button>
                                </td>
                            </tr>
                            ...
                            <tr>
                                <td className="px-6 py-4 whitespace-nowrap">
                                    <div
                                        className="text-sm font-medium text-gray-900">Vegetarian
                                        Lasagna
                                    </div>
                                </td>
                                <td className="px-6 py-4 whitespace-nowrap">
                                    <div
                                        className="text-sm text-gray-900">lisa_smith
                                    </div>
                                </td>
                                <td className="px-6 py-4 whitespace-nowrap">
                            ...
                            <tr>
                                <td className="px-6 py-4 whitespace-nowrap">
                                    <div
                                        className="text-sm font-medium text-gray-900">Apple
                                        Cinnamon Pie
                                    </div>
                                </td>
                                <td className="px-6 py-4 whitespace-nowrap">
                                    <div
                                        className="text-sm text-gray-900">chef_jamie
                                    </div>
                                </td>
                                <td className="px-6 py-4 whitespace-nowrap">
                                    <div className="text-sm text-gray-500">5
                                        hours ago
                                    </div>
                                </td>
                                <td className="px-6 py-4 whitespace-nowrap">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-8">
                    ...
                    >
                        <div className="p-3 rounded-full bg-blue-100 mr-4">
                            <svg xmlns="http://www.w3.org/2000/svg"
                                 className="h-6 w-6 text-blue-600" fill="none"
                        ...
                        <div>
                            <h3 className="font-medium text-gray-900">User
                                Management</h3>
                            <p className="text-sm text-gray-500 mt-1">Manage
                                user accounts, roles and permissions</p>
                        </div>
                    </Link>
                    ...
                    >
                        ...
                        <div>
                            <h3 className="font-medium text-gray-900">Content
                                Management</h3>
                            <p className="text-sm text-gray-500 mt-1">Manage
                                recipes, ingredients and categories</p>
                        </div>
                    </Link>
                    ...
                    >
                        ...
                        <div>
                            <h3 className="font-medium text-gray-900">System
                                Settings</h3>
                            <p className="text-sm text-gray-500 mt-1">Configure
                                application settings and preferences</p>
                        </div>
                    </Link>
                </div>
            </div>
