									...
									<div className="mt-3 text-center sm:mt-0 sm:text-left w-full">
										...
										<form onSubmit={handleSubmitReview} className="mt-4">
												...
												<div className="flex items-center gap-2">
													{[1, 2, 3, 4, 5].map((star) => (
														<button
															...
															className={`text-2xl ${userRating >= star
																? "text-yellow-400"
																: "text-gray-300"
											...
											<div className="mt-6 flex justify-end space-x-3">
												...
												<button
													type="submit"
													className="inline-flex justify-center px-4 py-2 text-sm font-medium text-white bg-[#7A5AFF] border border-transparent rounded-md hover:bg-[#6B4EE2] focus:outline-none"
												>
													Submit Review
												</button>
											</div>
