          ...
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <div>
              ...
              <p className="text-gray-500">
                Discover, organize, and enjoy your favorite dishes
              </p>
            </div>
            <Link
              to="/recipes/add"
          ...
          <div className="lg:col-span-3">
            ...
            {debugInfo && (
              <div className="bg-yellow-50 border border-yellow-200 text-yellow-800 px-6 py-4 rounded-lg mb-6 shadow-sm">
                ...
                <pre className="text-xs overflow-x-auto mt-2 bg-yellow-100 p-3 rounded">
                  {debugInfo}
                </pre>
              </div>
            )}
                ...
                {recipes.length === 0 && !error && (
                  <div className="bg-white rounded-xl shadow-sm p-12 text-center">
                    ...
                    <p className="text-gray-500 mb-6 max-w-md mx-auto">
                      Your culinary journey starts here. Click 'Add New Recipe'
                          ...
                          <div className="mt-auto">
                            ...
                            <div className="flex gap-2">
                              ...
                              <Link
                                ...
                                className="flex-1 bg-gray-100 hover:bg-gray-200 text-gray-800 font-medium py-3 px-4 rounded-lg text-center transition-colors duration-200 border border-gray-200"
                              >
                                View Details
                              </Link>
                              <button
              ...
              <div className="inline-block w-full max-w-md p-6 my-8 overflow-hidden text-left align-middle transition-all transform bg-white shadow-xl rounded-2xl">
                ...
                <form onSubmit={handleSubmitReview} className="mt-4">
                  ...
                  <div className="mt-6 flex justify-end space-x-3">
                    ...
                    <button
                      type="submit"
                      className="inline-flex justify-center px-4 py-2 text-sm font-medium text-white bg-[#7A5AFF] border border-transparent rounded-md hover:bg-[#6B4EE2] focus:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-blue-500"
                    >
                      Submit Review
                    </button>
                  </div>
