        ...
        <>
            ...
            <main className="min-h-screen">
                <Routes>
                    ...
                    <Route path="/admin/recipes" element={<Admin><ManageRecipes/></Admin>}/>
                    <Route path="/admin/ingredients" element={<Admin><IngredientDatabase/></Admin>}/>
                    <Route path="/admin/recipes/add" element={<Admin><EditRecipe/></Admin>}/>
                    <Route path="/admin/recipes/edit/:id" element={<Admin><EditRecipe/></Admin>}/>
